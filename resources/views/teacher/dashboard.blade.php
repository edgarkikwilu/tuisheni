    ...
    <div class="row justify-content-center">
            ...
            <div class="card card-chart">
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    <h5 class="card-category">Monthly Points Earned</h5>
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="card-body">
                <div class="chart-area">
                    <canvas id="yearPointChart" style="height:250px;"></canvas>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Weekly Earned Points Chart</h5>
              </div>
              <div class="card-body">
                <div class="chart-area">
                  {{-- {!! $monthPointChart->render() !!} --}}
                  <canvas id="weeklyPointChart" width="400" height="400"></canvas>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Weekly Exams Average Score</h5>
              </div>
              <div class="card-body">
                <div class="chart-area">
                  <canvas id="weeklyPerfomanceChart"></canvas>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Uploaded Content Analysis</h5>
              </div>
              <div class="card-body">
                <div class="chart-area">
